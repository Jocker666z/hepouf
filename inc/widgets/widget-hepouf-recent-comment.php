 ...
 * @since 2.8.0
 */
add_action( 'widgets_init', create_function( '', 'register_widget( "aThemes_Recent_Comments" );' ) );
class aThemes_Recent_Comments extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'aThemes_Recent_Comments', 'description' => __( 'Your site&#8217;s most recent comments.' ) );
		parent::__construct('recent-comments', __('Hepouf Recent Comments'), $widget_ops);
...
<?php
	...
	public function widget( $args, $instance ) {
		...
		$output .= '<div class="sidebar-block-fondu"><ul class="recentcomments-block">';
		if ( $comments ) {
